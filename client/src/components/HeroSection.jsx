...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <h1 className='text-5xl md:text-[70px] md:leading-[70px] font-semibold max-w-[110ch]'>
      ...
      <button onClick={()=>navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hoverbg-primary-dull transition rounded-full font-medium cursor-pointer'>
        Explore Movies
